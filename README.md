...
> **Immutable template:** `invoice.pdf` is the locked original BNC invoice template. The project code may generate filled/extended invoices from it, but the template file itself must not be modified.
